...
<head>
  ...
  <style>
    ...
    /* Further Development has 7 chips — scale down slightly to fit one row */
    .subject-tab[data-phase="furtherdev"] {{ height: 2.2rem; font-size: 0.7rem; padding: 0 0.65rem; gap: 0.35rem; }}
